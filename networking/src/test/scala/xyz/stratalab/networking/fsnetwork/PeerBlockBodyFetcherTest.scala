...
import xyz.stratalab.models.generators.consensus.ModelGenerators.nonEmptyChainArbOf
...
import xyz.stratalab.networking.fsnetwork.BlockDownloadError.BlockBodyOrTransactionError.TransactionHaveIncorrectSyntax
